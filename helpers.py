...
def getSets(userid:int):
    ...
    Returns the sets as an array of dictionaries
    """
    # TODO: Decide on sort options and what keys are in dictionary
    pass

def getCards(setid:int):
    """Get all the cards in the given set

    Returns the cards as an array of dictionaries with the following keys:
    'id'
    'front'
    'back'
    'indicator'
